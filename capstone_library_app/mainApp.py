...
#input the menu
menu = str(input("Enter the number of the menu you want to run: "))
...
while menu != '6':
    if menu == '1' : #display data
        ...
        inputDisplay= str(input("Enter the number of the menu you want to run: "))
        ...
        while inputDisplay !='4' :
            if inputDisplay == '1':
                ...
                editTransactions(borrowTransaction,user,book)
            else:
                pass
            print("\n--------------------------------------------------\n")
            displayMenu(editOptionMenu)
        ...
        while inputDisplay !='4' :
            if inputDisplay == '1':
                ...
                deleteTransactions(borrowTransaction,returnTransaction,user,book)
            else:
                pass
            print("\n--------------------------------------------------\n")
            displayMenu(deleteOptionMenu)
